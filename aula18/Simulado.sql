...
CREATE TABLE Materia (
    ...
    CONSTRAINT fk_feitico (IDFeitico) REFERENCES Feitico (IDFeitico)
)
...
CREATE TABLE professores (
    ...
    CONSTRAINT fk_materia (IDMateria) REFERENCES Materia (IDMateria)
    IDcasa INT NOT NULL
    CONSTRAINT fk_casa (IDcasa) REFERENCES casa (IDcasa)
    IDFeitico INT NOT NULL
    CONSTRAINT fk_feitico (IDFeitico) REFERENCES Feitico (IDFeitico)
)
...
CREATE TABLE personagem (
    ...
    CONSTRAINT fk_professor (IDPROFESSOR) REFERENCES professores (IDPROFESSOR)
)
...
INSERT INTO (IDPROFESSOR, nomeProfessor, idadeProfessor,IDMateria,IDcasa,IDFeitico)
VALUES
...
INSERT INTO personagem (idPersonagem,nomePersonagem,dataDeNascimento,IDMateria, IDcasa, IDFeitico)
VALUES
(1,"Harray potter", "31 de julho de 1980", 1,1,1)
(2, "Draco Lúcio Malfoy", "5 de junho de 1980",1,4,4)
(3,"Hermione Granger", "19 de setembro de 1979", 3,1,3)
(4,"Ron Weasley", "1 de março de 1980", 4,1,2)
(5,"Voldemort", "31 de dezembro de 1926", 1,4,4)
